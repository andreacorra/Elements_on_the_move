...
migrate_and_resident_nitrogen <- readRDS("data_anonymized/migrate_and_resident_nitrogen.rds")
resident_150_nitrogen <- readRDS("data_anonymized/resident_150_nitrogen.rds")
resident_300_nitrogen <- readRDS("data_anonymized/resident_300_nitrogen.rds")
migration_150_nitrogen <- readRDS("data_anonymized/migration_150_nitrogen.rds")
...
spatial_covariates <- readRDS("data_anonymized/spatial_covariates.rds")
...
aspect <- rast("data_anonymized/aspect.tif")
roads <- st_read("data_anonymized/roads.shp") 
